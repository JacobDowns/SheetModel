# -*- coding: utf-8 -*-
"""
Steady state sim. Spatially varying k. Flat bed. Low melt.
"""
...
pcs['k'] = 5e-3
pcs['k_c'] = 1e-1
model_inputs['input_file'] = 'inputs_channel/inputs_channel_ref_low.hdf5'
model_inputs['out_dir'] = 'channel_realistic/out_channel_ref_realistic_low/'
