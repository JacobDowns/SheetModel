# -*- coding: utf-8 -*-
"""
Gammut of high melt lag time tests. Low storage.
"""
...
k_min = 5e-5
k_max = 5e-3
scale_functions = ScaleFunctions(input_file, k_min, k_max, u_b_max = 80.)
...
for b in lag_times:
  scale_functions.b = b
  name = names[i]
  model_inputs['out_dir'] = 'channel_results/real_lag_high2/' +  name + '_lag'
