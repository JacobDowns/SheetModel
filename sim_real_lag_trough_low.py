# -*- coding: utf-8 -*-
"""
Gammut of low melt lag time tests. Trough bedrock geometry.
"""
...
input_file = 'inputs_channel/steady/real_trough_steady_low.hdf5'
k_min = 5e-5
k_max = 5e-3
...
for b in lag_times:
  scale_functions.b = b
  name = names[i]
  model_inputs['out_dir'] = 'channel_results/real_lag_trough_low/' +  name + '_lag'
