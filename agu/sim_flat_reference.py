"""
Runs a simulation on a geometry with a flat bed. Melt is reduced over time while
conductivity and sliding are kept constant. 
"""
...
# Output directory
out_dir = "out_flat_bed_reference/"
