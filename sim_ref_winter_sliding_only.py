"""
Winter simulation on a flat bed where conductivity remains constant but sliding
decreases. 
"""
...
scale_functions = ScaleFunctions(input_file, 5e-3, 5e-3, u_b_max = 20.0)
...
model_inputs['out_dir'] = 'paper_results/out_ref_winter_sliding_only/'
