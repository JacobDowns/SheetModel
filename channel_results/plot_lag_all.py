...
h4_out = File('lag/low_week_lag/h.pvd')
h5_out = File('lag/high_month_lag/h.pvd')
h6_out = File('lag/low_month_lag/h.pvd')

pfo1_out = File('lag/high_day_lag/pfo.pvd')
pfo2_out = File('lag/low_day_lag/pfo.pvd')
pfo3_out = File('lag/high_week_lag/pfo.pvd')
pfo4_out = File('lag/low_week_lag/pfo.pvd')
pfo5_out = File('lag/high_month_lag/pfo.pvd')
pfo6_out = File('lag/low_month_lag/pfo.pvd')

S1_out = File('lag/high_day_lag/S.pvd')
S2_out = File('lag/low_day_lag/S.pvd')
