...
h1_out = File('high_day_lag/h.pvd')
h2_out = File('low_day_lag/h.pvd')
h3_out = File('high_week_lag/h.pvd')
h4_out = File('low_week_lag/h.pvd')
h5_out = File('high_month_lag/h.pvd')
h6_out = File('low_month_lag/h.pvd')
