...
h1_out = File('lag2/high_day_lag/h.pvd')
h2_out = File('lag2/low_day_lag/h.pvd')
h3_out = File('lag2/high_week_lag/h.pvd')
h4_out = File('lag2/low_week_lag/h.pvd')
h5_out = File('lag2/high_month_lag/h.pvd')
h6_out = File('lag2/low_month_lag/h.pvd')

pfo1_out = File('lag2/high_day_lag/pfo.pvd')
pfo2_out = File('lag2/low_day_lag/pfo.pvd')
pfo3_out = File('lag2/high_week_lag/pfo.pvd')
pfo4_out = File('lag2/low_week_lag/pfo.pvd')
pfo5_out = File('lag2/high_month_lag/pfo.pvd')
pfo6_out = File('lag2/low_month_lag/pfo.pvd')

input_file1 = HDF5File(mpi_comm_world(), 'lag2/high_day_lag.hdf5', 'r') 
input_file2 = HDF5File(mpi_comm_world(), 'lag2/low_day_lag.hdf5', 'r')
input_file3 = HDF5File(mpi_comm_world(), 'lag2/high_week_lag.hdf5', 'r')  
input_file4 = HDF5File(mpi_comm_world(), 'lag2/low_week_lag.hdf5', 'r')  
input_file5 = HDF5File(mpi_comm_world(), 'lag2/high_month_lag.hdf5', 'r')  
input_file6 = HDF5File(mpi_comm_world(), 'lag2/low_month_lag.hdf5', 'r')  
